        ...
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="pt-4 flex justify-center relative">
            <div className="max-w-[280px] md:max-w-[320px] rounded-2xl overflow-hidden shadow-2xl border-4 border-green-600 bg-white ring-8 ring-green-600/5 relative">
              ...
              {/* CONTROL BADGE */}
              <div className="absolute top-4 -right-4 bg-stone-900 text-white text-[10px] font-black px-3 py-2 rounded-xl shadow-2xl rotate-12 animate-bounce">
                Fiyat güncellemek 3 saniye! ⏱️
              </div>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto bg-stone-900 rounded-[2.5rem] pt-8 pb-10 md:pt-12 md:pb-14 px-6 md:px-10 text-center space-y-8 shadow-3xl relative overflow-hidden w-full">
          ...
          <div className="relative z-20 flex justify-center w-full">
             <a href="https://wa.me/905373420161" target="_blank" rel="noreferrer">
               <Button variant="primary" mode="rectangle" size="lg" className="!bg-[#25D366] !text-white shadow-2xl transition-all active:scale-95 hover:scale-110 group border-none !p-8 md:!p-10 !rounded-full">
                 <svg className="w-12 h-12 md:w-14 md:h-14 fill-white drop-shadow-sm group-hover:rotate-12 transition-transform" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
