    ...
    <div className="min-h-screen bg-white font-sans selection:bg-stone-900 selection:text-white">
      ...
      <div className="sticky top-0 z-[100] bg-green-600 text-white py-3 px-4 text-center shadow-lg overflow-hidden">
        <p className="text-[10px] md:text-[12px] font-medium uppercase tracking-[0.1em] md:tracking-[0.2em] whitespace-nowrap opacity-90 flex items-center justify-center">
          domain <span className="font-black opacity-100 ml-1">hediye!</span> <span className="mx-2 opacity-50">→</span> 
      ...
      <section className="pt-12 pb-20 px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-base md:text-lg text-stone-500 font-medium leading-relaxed">
            Fiyatlar zamlandığında kataloglarınızı saniyeler içinde güncelleyin. Angaryaya değil, işinize odaklanın.
          </p>
          ...
          <div className="pt-10 md:pt-16 max-w-3xl mx-auto">
            <div className="grid grid-cols-3 gap-2 md:gap-4 bg-white/60 backdrop-blur-md p-4 md:p-8 rounded-xl border border-stone-100 shadow-xl shadow-stone-200/50">
              <div className="space-y-1 md:space-y-4 p-2">
                <div className="w-8 h-8 md:w-12 md:h-12 bg-stone-900 rounded-xl md:rounded-2xl flex items-center justify-center text-white mx-auto text-sm md:text-xl font-black">1</div>
                <h3 className="text-[10px] md:text-xl font-black tracking-tight text-stone-900 leading-tight">Listenizi Atın</h3>
                <p className="text-stone-500 text-[10px] md:text-sm leading-tight font-medium hidden md:block">WhatsApp'tan gönderin.</p>
              </div>
              <div className="space-y-1 md:space-y-4 p-2">
                <div className="w-8 h-8 md:w-12 md:h-12 bg-stone-900 rounded-xl md:rounded-2xl flex items-center justify-center text-white mx-auto text-sm md:text-xl font-black">2</div>
                <h3 className="text-[10px] md:text-xl font-black tracking-tight text-stone-900 leading-tight">Biz Kuralım</h3>
                <p className="text-stone-500 text-[10px] md:text-sm leading-tight font-medium hidden md:block">Aynı gün teslim.</p>
              </div>
              <div className="space-y-1 md:space-y-4 p-2">
                <div className="w-8 h-8 md:w-12 md:h-12 bg-green-500 rounded-xl md:rounded-2xl flex items-center justify-center text-white mx-auto text-sm md:text-xl font-black shadow-lg shadow-green-500/20">
                  <svg className="w-4 h-4 md:w-6 md:h-6 stroke-current stroke-[4px]" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <h3 className="text-[10px] md:text-xl font-black tracking-tight text-stone-900 leading-tight">Siz Yönetin</h3>
                <p className="text-stone-500 text-[10px] md:text-sm leading-tight font-medium hidden md:block italic">Fiyatları anında güncelleyin.</p>
              </div>
            </div>
          </div>
            ...
            <div className="text-center flex flex-col items-center pt-36">
              <div className="w-fit flex flex-col items-center relative">
                ...
                <p className="text-[10px] md:text-sm font-black text-stone-300 uppercase tracking-[0.3em] line-through mb-1">₺500 / AY</p>
                <p className="text-7xl md:text-9xl font-black text-stone-900 tracking-tighter leading-none pr-1">
                  ₺399<span className="text-xl font-bold opacity-30 ml-2">&nbsp;/&nbsp;ay&nbsp;</span>
                </p>
      ...
      <section className="pb-20 px-4 -mt-6 md:-mt-12">
        <div className="max-w-2xl mx-auto bg-stone-900 rounded-[2.5rem] pt-8 pb-10 md:pt-12 md:pb-14 px-6 md:px-10 text-center space-y-8 shadow-3xl relative overflow-hidden w-full">
          ...
          <div className="relative z-20 flex justify-center w-full">
             <a href="https://wa.me/905373420161" target="_blank" rel="noreferrer">
               <motion.div
                 animate={{ boxShadow: `${shadowOffset.x}px ${shadowOffset.y}px 40px rgba(37, 211, 102, 0.4)` }}
                 transition={{ type: 'spring', bounce: 0.2, duration: 0.8 }}
                 className="rounded-full"
               >
                 <Button variant="primary" mode="rectangle" size="lg" className="!bg-[#25D366] !text-white flex items-center justify-center transition-all active:scale-95 group border-none !p-8 md:!p-10 !rounded-full">
                   <svg className="w-12 h-12 md:w-14 md:h-14 fill-white drop-shadow-sm group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-white/40 text-[10px] md:text-sm font-bold uppercase tracking-[0.2em] relative z-10 w-full text-center">Taahhüt yok, cayma bedeli yok.</p>
        </div>
        ...
        <div className="mt-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-2 duration-1000 delay-700">
          <a href="tel:905373420161" className="bg-stone-900 rounded-3xl px-8 py-4 flex items-center gap-4 group hover:bg-stone-800 hover:shadow-2xl transition-all cursor-pointer">
            ...
            <p className="text-xl font-black text-white tracking-tighter transition-colors group-hover:text-stone-300">+90 537 342 01 61</p>
          </a>
        </div>
      </section>
