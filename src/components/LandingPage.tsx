...
const PRICING_PHRASES = [
  "aylık bir paket kahve fiyatına",
  "aylık bir büyük boy pizza fiyatına",
  "aylık sadece 8 adet ekmek fiyatına"
];
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-stone-900 selection:text-white pb-10">
      {/* STICKY PROMO BAR */}
      ...
      <section className="pt-12 pb-20 px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <div className="pt-4 flex justify-center">
            <div className="max-w-[280px] md:max-w-[320px] rounded-2xl overflow-hidden shadow-2xl border-4 border-green-600 bg-white ring-8 ring-green-600/5">
          ...
          <div className="pt-10 flex flex-col items-center space-y-6">
            <div className="text-center flex flex-col items-center">
                ...
                <div className="relative h-3 md:h-4 w-full -mt-1 md:-mt-2 overflow-visible">
                  <AnimatePresence mode="wait">
                    <motion.p
                      ...
                      className="text-green-600 font-black text-[7px] md:text-[9px] uppercase tracking-[0.3em] md:tracking-[0.45em] text-center whitespace-nowrap absolute inset-0 flex items-center justify-center"
                    >
              ...
              <p className="mt-8 text-[11px] font-black text-stone-900 uppercase tracking-[0.2em] bg-stone-100 px-4 py-2 rounded-full">
                Denemesi Bedava: İlk faturanız 30 gün sonra!
              </p>
            </div>

            {/* SETUP ASSISTANCE BADGE */}
            <div className="bg-stone-50 border border-stone-100 px-6 py-4 rounded-3xl flex items-center gap-4 animate-in fade-in zoom-in duration-700 delay-300 max-w-sm">
      ...
      <section className="pb-10 pt-2 md:pb-20 md:pt-4 px-4">
        <div className="max-w-2xl mx-auto bg-stone-900 rounded-[3.5rem] pt-6 pb-8 md:pt-12 md:pb-16 px-12 text-center space-y-8 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-none relative z-10">Hemen başlayalım.</h2>
            <a href="https://wa.me/905550000000" target="_blank" rel="noreferrer" className="inline-block relative z-20">
              <Button variant="primary" size="lg" className="!bg-[#25D366] !text-white !rounded-full p-6 md:p-8 shadow-2xl transition-all active:scale-95 hover:scale-110 group border-none flex items-center justify-center gap-3">
                <svg className="w-8 h-8 fill-white drop-shadow-sm group-hover:rotate-12 transition-transform" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-xl md:text-2xl font-black">WHATSAPP</span>
              </Button>
            </a>
        </div>
      </section>

      <footer className="text-center border-t border-stone-100 pt-10 flex flex-col items-center gap-4 px-4 pb-12">
