        ...
        <div className="flex justify-between py-2 items-center gap-4">
          ...
          <div className="flex items-center gap-2 select-none shrink-0">
            ...
            <div className="flex flex-col">
              <div
                className={`${n.logoNameSize} ${n.logoNameWeight} text-stone-900 leading-none tracking-tight`}
              >
                {COMPANY.name}
              </div>
              <div
                className={`${n.logoTaglineSize} ${n.logoTaglineColor} font-medium`}
              >
                {COMPANY.tagline}
              </div>
            </div>
          ...
          <div className="flex flex-col items-end gap-1 shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  className={`${n.instaIconSize} fill-current`}
                  aria-hidden="true"
                >
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  className={`${n.whatsappIconSize} fill-current`}
                  aria-hidden="true"
                >
                ...
                <span className={`${n.phoneSize} ${n.phoneWeight}`}>
                  {COMPANY.phone}
                </span>
              </a>
            </div>
