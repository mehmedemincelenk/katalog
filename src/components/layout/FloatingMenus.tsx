...
import { generateVCard, openWhatsApp, callPhone, openInstagram } from '../../utils/contact';
...
// ---------------------------------------------------------------------------
// 2. FLOATING GUEST MENU
// ---------------------------------------------------------------------------
export function FloatingGuestMenu({
  onCouponClick,
  onSearchClick,
  onQRClick,
}: FloatingGuestMenuProps) {
  ...
  const guestActions: FloatingAction[] = [
    ...
    {
      id: 'qr',
      icon: <Lucide.QrCode className="w-5 h-5" strokeWidth={2.5} />,
      action: onQRClick,
      label: '', 
      variant: 'secondary',
    },
    {
      ...
      action: () => openWhatsApp(whatsappNumber, "Merhaba, ürünleriniz hakkında bilgi almak istiyorum."),
      label: '', 
      variant: 'whatsapp',
    },
    {
      id: 'search',
      icon: <Lucide.Search className="w-5 h-5" strokeWidth={2.5} />,
