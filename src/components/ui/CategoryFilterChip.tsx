  ...
  ({
    ...
    return (
      ...
      >
        {showFingerprint && (
          <div
            className={`absolute opacity-[0.03] pointer-events-none transition-transform duration-500 -right-2 -bottom-2 ${isItemSelected ? 'opacity-[0.08] scale-110' : 'group-hover:scale-110 group-hover:opacity-[0.05]'}`}
