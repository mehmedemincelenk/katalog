...
export const THEME = {
  ...
  announcementBar: {
    wrapper: 'w-full bg-[var(--primary)] text-white py-1.5 sm:py-2 px-4 text-center relative',
  ...
  button: {
    ...
    variants: {
      primary: 'bg-[var(--primary)] text-white border-transparent shadow-xl hover:bg-[var(--primary-hover)] transition-standard',
      secondary: 'bg-white text-[var(--primary)] border-[var(--secondary)] shadow-lg hover:bg-[var(--secondary)] transition-standard',
      ...
      glass: 'bg-white/40 backdrop-blur-md text-stone-900 border-white/20 hover:bg-white shadow-xl transition-standard',
  ...
  productCard: {
    ...
    typography: {
      ...
      price: `${FS.base} sm:text-3xl font-black tracking-tight transition-smooth`,
  ...
  addProductModal: {
    overlay: 'fixed inset-0 z-[300] flex items-center justify-center bg-black/40 backdrop-blur-md p-4 transition-smooth',
    ...
    wizard: {
      ...
      progressBase: 'h-1 sm:h-2 w-6 sm:w-12 rounded-full transition-smooth duration-500',
